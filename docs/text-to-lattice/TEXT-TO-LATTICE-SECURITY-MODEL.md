...
- **Required before publication:**
  ...
  - Retain the reviewed official browser flow and two-origin privacy trace under satisfied GATE-06, and repeat them after consequential changes; continue keyboard and assistive-technology verification under GATE-05.
- **Residual boundary:**
...
- **As built:**
  ...
  - GATE-06 binds its satisfied production status to the canonical deployed workflow and commit, dated Safari/WebKit and Brave/Chromium capture identities and digests, the zero-match privacy review, and explicit testing-profile claim limits.
- **Required before publication:**
