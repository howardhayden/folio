...
function getDraftSecret() {
	return "0656a502-218c-4705-946b-0e9647c529b2";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "ef7111f3-7c6c-4ff5-962d-4e9affe5af5d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "ef7111f3-7c6c-4ff5-962d-4e9affe5af5d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "ef7111f3-7c6c-4ff5-962d-4e9affe5af5d",
		rootBoundaryId
	});
}
/**
