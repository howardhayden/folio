...
var client_references_default = {
	...
	"33984f554e77": async () => {
		const m = await import("./assets/ShelfExplorer-DiLZV-Cs.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"59544f697442": async () => {
		const m = await import("./assets/AsciiArt-nnE3hnq3.js");
		return { get "AsciiArt"() {
			return m["AsciiArt"];
		} };
	},
	"76d8cb3b8699": async () => {
		const m = await import("./assets/ResumeExperience-BMHjsAAb.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-CKajqAad.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	}
