  ...
  securityAndPrivacy: Object.freeze({
    ...
    huggingFace: Object.freeze({
      ...
      protections: Object.freeze([
        ...
        "Provider calls omit caches, reject redirects, use strict JSON Schema outputs, and enforce bounded request, response, token, and time limits. A schema-correction pass may call the same fixed model again within the pipeline budget; it does not switch providers.",
