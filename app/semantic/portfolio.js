...
function usagePolicyMarkdown() {
  ...
  return [
    ...
    `- Human verification: ${policy.enforcement.humanAttestation.provider}; action ${policy.enforcement.humanAttestation.action}; hostname ${policy.enforcement.humanAttestation.hostname}; ${policy.enforcement.humanAttestation.browserIsolation}; message boundary: ${policy.enforcement.humanAttestation.messageBoundary}; source transmission: ${policy.enforcement.humanAttestation.sourceTransmission}`,
