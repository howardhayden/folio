...
export const staticSourceCopies = Object.freeze([
  ...
  // Historical evidence only; current Owner-controlled material uses LicenseRef-Hayden-Proprietary-1.1.
  sourceCopyRecord("/LICENSES/HISTORICAL/LicenseRef-Hayden-Proprietary-1.0.txt", "LICENSES/HISTORICAL/LicenseRef-Hayden-Proprietary-1.0.txt", "LICENSES/HISTORICAL/LicenseRef-Hayden-Proprietary-1.0.txt", "text/plain"),
