...
| Qwen3-4B-Instruct-2507 generator | `Qwen/Qwen3-4B-Instruct-2507:nscale`; provider-managed serving revision | https://huggingface.co/Qwen/Qwen3-4B-Instruct-2507 | The upstream Qwen3-4B-Instruct-2507 model is [Apache-2.0](LICENSES/Apache-2.0.txt). |
| Llama 3.1 8B Instruct verifier | `meta-llama/Llama-3.1-8B-Instruct:deepinfra`; provider-managed serving revision | https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct | Governed by the supplied [Llama 3.1 Community License](LICENSES/Llama-3.1-Community-License.txt) and [Acceptable Use Policy](LICENSES/Llama-3.1-Acceptable-Use-Policy.md). |
...
| Nscale provider | Fixed generator provider selected through the Hugging Face router | https://huggingface.co/docs/inference-providers/en/providers/nscale | External service; upstream provider and platform policies apply. |
| DeepInfra provider | Fixed verifier provider selected through the Hugging Face router | https://huggingface.co/docs/inference-providers/en/providers/deepinfra | External service; upstream provider and platform policies apply. |
...
The supplied active Llama 3.1 terms are byte-identical snapshots from the official `meta-llama/Llama-3.1-8B-Instruct` repository at revision `0e9e39f249a16976918f6564b8830bc894c89659`: [`LICENSE`](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct/blob/0e9e39f249a16976918f6564b8830bc894c89659/LICENSE) has git blob `a7c3ca16cee30425ed6ad841a809590f2bcbf290` and SHA-256 `64e1b2889b7892e6bbe7a7ed5bfe6ff793c61f9d584345f8f41cf9f5cb30a369`; [`USE_POLICY.md`](https://huggingface.co/meta-llama/Llama-3.1-8B-Instruct/blob/0e9e39f249a16976918f6564b8830bc894c89659/USE_POLICY.md) has git blob `81ebb55902285e8dd5804ccf423d17ffb2a622ee` and SHA-256 `a568f2ebc73cec3fd74ba2afd992d4e945a8c7a9d851f9b66163aac834b7b859`. Current human-readable canonical sources are Meta's [Llama 3.1 license](https://developer.meta.com/ai/llama3_1/license/) and [acceptable-use policy](https://developer.meta.com/ai/llama3_1/use-policy/). This terms-file revision does not identify or pin the provider-managed serving revision.
...
The historical inactive Llama 3.2 license and acceptable-use policy remain byte-identical to the reviewed official files: SHA-256 `8cc15535a8a34b41888f644b339a1a9eb428af793a4f5e24df58a3e5b1487d74` and `40e2777d7faa6beaf98400654170f414d8ab29b921b5163ad4ea0a1d39894201`. Canonical sources are Meta's [Llama 3.2 license](https://developer.meta.com/ai/llama3_2/license/) and [acceptable-use policy](https://developer.meta.com/ai/llama3_2/use-policy/).
...
Llama 3.1 is licensed under the [Llama 3.1 Community License](https://developer.meta.com/ai/llama3_1/license/), Copyright © Meta Platforms, Inc. All Rights Reserved.
